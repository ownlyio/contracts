...
2) 6% buyback tax is collected and is used to buyback the tokens
...
contract Own is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x768532c218f4f4e6E4960ceeA7F5a7A947a1dd61); // Marketing Address
    ...
    string private _name = "OwnlyTest";
    string private _symbol = "OLT";
